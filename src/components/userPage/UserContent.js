      ...
      <div className="container">
        ...
        <div className={styles.user__content}>
          <aside className={styles.user__bar}>
            <button
              className={`${styles.user__btn} ${userContent === "contentOne" ? styles["user__btn-active"] : ""}`}
            ...
            <button
              className={`${styles.user__btn} ${userContent === "contentTwo" ? styles["user__btn-active"] : ""}`}
            ...
            <button
              className={`${styles.user__btn} ${userContent === "contentThree" ? styles["user__btn-active"] : ""}`}
